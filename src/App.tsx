...
const App: React.FC = () => {
    const handlePrint = (e: React.MouseEvent) => {
        ...
        // Tracking pour votre étude : on enregistre l'événement "download_pdf"
        track('download_pdf', {location: 'header_button'});
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans" style={{backgroundColor: COLORS.background}}>
            ...
            {/* Composant Analytics de Vercel (invisible mais collecte les données) */}
            <Analytics/>

            {/* Simple Header */}
            <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b no-print"
                 style={{borderColor: COLORS.border}}>
                <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">

                    <div className="flex items-center gap-4">
                        <div
                            className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#6A8EAE] to-[#4A6E8E] flex items-center justify-center text-white font-bold serif text-xl shadow-sm">
                            A
                        </div>
            ...
            <footer className="border-t py-12 mt-auto bg-white no-print" style={{borderColor: COLORS.border}}>
                <div
                    className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-400">
                    <p>© 2025 KM Mania Research. Tous droits réservés.</p>
                    <div className="flex gap-8">
                        <a href="https://www.linkedin.com/in/daclinhgiao-nguyen/" target="_blank"
                           rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">LinkedIn</a>
                        <a href="mailto:dlg.nguyen@gmail.com"
                           className="hover:text-gray-600 transition-colors">Contact</a>
                    </div>
                </div>
            </footer>
