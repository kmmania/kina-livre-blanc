...
const SectionHeader = ({children}: { children?: React.ReactNode }) => (
    <h2 className="text-3xl font-bold mb-8 serif mt-16 leading-tight break-inside-avoid"
...
const HighlightBox = ({title, quote, desc}: { title: string, quote: string, desc: string }) => (
    <div
        className="p-8 rounded-xl my-6 shadow-sm border bg-white hover:shadow-md transition-shadow duration-300 break-inside-avoid"
...
export const WhitePaperViewer: React.FC = () => {
    return (
        <div
            className="w-full bg-white shadow-xl rounded-none md:rounded-lg overflow-hidden my-0 md:my-4 print:shadow-none print:my-0 print:rounded-none">
            ...
            <span
                className="inline-block py-1 px-3 rounded-full bg-blue-50 text-blue-800 text-xs font-bold tracking-widest uppercase mb-6"
                style={{color: COLORS.primary, backgroundColor: '#f0f4f8'}}>
                Livre Blanc
            </span>
                    ...
                    <p className="text-base md:text-lg text-gray-400 font-medium">
                        Par <span className="text-gray-800 font-semibold">Dac Linh Giao NGUYEN</span>, le 20 novembre
                        2025
                    </p>
                </header>
                ...
                <section className="mb-24 break-inside-avoid">
                    ...
                    <div className="bg-gray-50 p-8 rounded-lg border-l-4" style={{borderColor: COLORS.primary}}>
                        ...
                        <p className="text-lg text-gray-700 mb-6 text-justify">
                            Vous êtes l'athlète de 2025, et vous vivez une transformation sans précédent dans l'histoire
                            du
                            sport d'endurance.
                        </p>
                ...
                <section className="mb-24">
                    ...
                    <h3 className="text-xl font-bold mb-10 text-gray-900 break-after-avoid">Cette révolution a créé
                        trois tensions majeures que vous vivez probablement au quotidien :</h3>
                    ...
                    <div className="space-y-10">
                        {[
                            ...
                            <div key={i} className="pl-6 border-l-2 break-inside-avoid"
                                 style={{borderColor: COLORS.border}}>
                                <h4 className="font-bold text-lg mb-3"
                                    style={{color: COLORS.textPrimary}}>{tension.title}</h4>
                    ...
                    <div className="mt-16 p-8 text-center bg-[#F8F8F8] rounded-xl break-inside-avoid">
                        <p className="text-2xl font-serif font-bold italic leading-relaxed text-center"
                           style={{color: COLORS.primary}}>
                ...
                <section className="mb-24">
                    ...
                    <p className="text-xl font-bold mb-4 text-gray-900 text-justify">La bonne nouvelle ? Rien de tout
                        cela n'est une fatalité.</p>
                    ...
                    <p className="text-lg text-gray-700 mb-12 text-justify">
                        Le problème, c'est l'usage non-conscient de ces outils. C'est la perte de votre souveraineté
                        cognitive et émotionnelle.
                    </p>

                    <h3 className="text-lg font-bold mb-10 uppercase tracking-wider text-center"
                        style={{color: COLORS.secondary}}>Les principes d'une pratique équilibrée</h3>

                    <div className="space-y-8">
                        {[
                            {
                                title: "1. La technologie comme copilote, pas comme pilote automatique",
                                desc: "Les données éclairent vos décisions, elles ne les prennent pas à votre place. Vous restez aux commandes."
                            },
                            {
                                title: "2. La progression long terme plutôt que l'optimisation constante",
                                desc: "Les plateaux sont normaux. Les cycles de forme sont naturels. Accepter la temporalité du corps, c'est respecter son humanité."
                            },
                            {
                                title: "3. Le plaisir intrinsèque comme boussole centrale",
                                desc: "Pourquoi avez-vous commencé à courir ? Cette raison première doit rester votre étoile polaire, même entourée de métriques et de classements."
                            },
                            {
                                title: "4. La confiance en vos sensations, complétées par les données",
                                desc: "Votre corps vous parle. Les algorithmes aussi. Apprendre à naviguer entre les deux, c'est développer une nouvelle forme d'intelligence."
                            }
                        ].map((p, i) => (
                            <div key={i}
                                 className="flex gap-6 p-6 rounded-lg transition-colors hover:bg-gray-50 break-inside-avoid">
                                <div
                                ...
                                <div>
                                    <h4 className="font-bold text-lg mb-3"
                                        style={{color: COLORS.textPrimary}}>{p.title.substring(3)}</h4>
                ...
                {/* Conclusion */}
                <section className="mb-24 break-inside-avoid">
                    <h3 className="text-3xl font-bold mb-8 serif text-center" style={{color: COLORS.primary}}>Vous
                        n'êtes pas seul dans ce voyage</h3>
                    <div
                        className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed space-y-6 text-justify">
                        <p>
                ...
                <section
                    className="border-t pt-16 mt-16 bg-[#fafafa] -mx-8 md:-mx-12 px-8 md:px-12 pb-12 break-inside-avoid">
                    <div className="max-w-3xl mx-auto">
                        <h3 className="text-xs font-bold uppercase tracking-widest mb-10 text-center text-gray-400">À
                            Propos de l'auteur</h3>
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                            <div className="text-center md:text-left w-full">
                                <h4 className="font-bold text-2xl mb-2" style={{color: COLORS.textPrimary}}>Dac Linh
                                    Giao NGUYEN</h4>
                                <p className="text-lg italic mb-6 font-serif" style={{color: COLORS.primary}}>Tech
                                    Entrepreneur & Marathonien</p>
                                <p className="text-gray-600 leading-relaxed mb-8 text-lg text-justify">
                                    ...
                                    Il est le fondateur de KM Mania, une initiative dédiée à l'innovation centrée sur
                                    l'humain
                                    pour libérer le véritable potentiel des athlètes d'endurance.
                                </p>

                                <div
                                    className="flex flex-col sm:flex-row gap-6 justify-center md:justify-start text-base font-medium border-t border-b py-6 border-gray-200"
                        ...
                        <div
                            className="mt-16 text-center text-xs text-gray-400 max-w-2xl mx-auto leading-relaxed text-justify">
                            <p className="mb-2 text-center">© 2025 - Dac Linh Giao NGUYEN / KM Mania Research.</p>
                            <p>Ce document est protégé par le droit d'auteur. Toutefois, je crois au partage de la
                                connaissance. Vous êtes autorisé et encouragé à diffuser ce manifeste, à condition de le
                                transmettre dans son intégralité, sans modification, et de toujours citer l'auteur et la
                                source.</p>
                            <p className="mt-4 italic">Avis de non-responsabilité : Les analyses présentées ici sont le
                                fruit d'une recherche qualitative. Elles visent à éclairer la pratique sportive mais ne
                                remplacent en aucun cas un avis médical ou un coaching professionnel.</p>
                        </div>
                    </div>
                </section>
            </div>
